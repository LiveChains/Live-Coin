...
unlocked to sign the Livecoin-Qt.app bundle.
...
allowing somebody to distribute a Livecoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the livecoin-qt.exe file inside the installer had not been tampered with.
